...
const completedProjectsData = [
  ...
  },
  {
    ...
    description: "기능등급제 현행 제도 타당성 분석, 해외 사례 분석을 통한 범제도적 개선안을 제시하였다.",
    start_date: "2024-04",
    end_date: "2024-11",
    funding_agency: "건설근로자공제회",
    amount: 0,
    image: "completed_cwma1.jpg",
    category: "제도/평가"
  },
  {
    id: 19,
    title: "인천구월 공공주택지구 및 검단일반산업단지 조성공사 사후평가용역",
    ...
    start_date: "2022-10",
    end_date: "2023-10",
    funding_agency: "인천도시공사",
    amount: 0,
    image: "completed_post-ev1.jpg",
    category: "제도/평가"
  },
  {
    id: 20,
  ...
  {
    id: 24,
    title: "건설근로자 기능 등급 구분·관리 기준 타당성 검토 용역",
    description: "기능등급 구분·관리 기준 분석 및 타당성 검토 이후 제도 개선 등을 통해 현장 수용성 강화 및 활성화 도모에 있어 본 과업의 목적이 있다.",
    start_date: "2023-10",
    end_date: "2024-04",
    funding_agency: "건설근로자공제회",
    amount: 0,
    image: "completed_cwma2.jpg",
    category: "제도/평가"
  },
  {
    id: 25,
    title: "당진화력 9,10호기 토건공사 사후평가용역",
    description: "당진화력 9,10호기 토건공사 계획 시 예상한 사업효과와 공사 완료 후의 실제 효과를 조사․분석하고, 사용자의 만족도 조사와 공사비․공사기간 등 건설공사에 대한 전반적인 평가를 시행하여 향후 유사한 건설공사 시 관련 자료로 활용하여 사업의 효율성을 도모하였다.",
    start_date: "2023-12",
    end_date: "2024-03",
    funding_agency: "한국건설기술연구원",
    amount: 0,
    image: "completed_post-ev2.jpg",
    category: "제도/평가"
  },
  {
    id: 26,
    title: "을숙도대교~장림고개간 지하차도 건설공사 사후평가용역",
    description: "을숙도대교~장림고개간 지하차도 건설공사 계획 시 예상한 사업효과와 공사 완료 후의 실제 효과를 조사․분석하고, 공사비․공사기간 등 건설공사에 대한 전반적인 평가를 시행하여 향후 유사한 건설공사 시 관련 자료로 활용하여 사업의 효율성을 도모하였다.",
    start_date: "2024-12",
    end_date: "2025-03",
    funding_agency: "한국건설기술연구원",
    amount: 0,
    image: "completed_post-ev4.jpg",
    category: "제도/평가"
  },
  {
    id: 27,
    title: "미래 건축산업 경쟁력 강화를 위한 BIM 이용 활성화 전략 마련 연구",
    description: "설계 자동화 기술, Pre-construction 및 지능형 유지관리 기술에 대한 사례조사 및 요소기술 조사를 통하여 BIM 활성화 로드맵 보고서를 작성하였다.",
    start_date: "2020-08",
    end_date: "2020-11",
    funding_agency: "한국건설기술연구원",
    amount: 0,
    image: "completed_bim_roadmap.jpg",
    category: "BIM, 제도/평가"
  }
];
/*
